                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text("Красный проспект, 72"),
                      ),
                    ),
                    Text("Выберите одну из привязанных карт"),
                    Container(
                      margin: EdgeInsets.symmetric(vertical: 12.0),
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.all(Radius.circular(8.0)),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.symmetric(
                                          vertical: 16.0),
                                      child: Text(
                                        "Вы можете отслеживать ваш заказ во вкладке 'Заказы'",
