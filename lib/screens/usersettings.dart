      ...
      child: Column(
        children: <Widget>[
          ...
          SettingsItem(Feather.getIconData("settings"), '#FDB78B',
              'Настройки аккаунта', 'Позволяет изменить данные аккаунта', () {
            Navigator.push(
              context,
              PageTransition(
                type: PageTransitionType.fade,
          ...
          SettingsItem(
              ...
              '#57CFE2',
              'Купоны',
              'Ваши купоны для покупки товара', () {
            Navigator.push(
              context,
              PageTransition(
                type: PageTransitionType.fade,
          ...
          SettingsItem(Feather.getIconData("message-circle"), '#606B7E',
              'Мои отзывы', 'Ваши отзывы на различные товары', () {
            Navigator.push(
              context,
              PageTransition(
                type: PageTransitionType.fade,
          ...
          SettingsItem(Feather.getIconData("bell"), '#FB7C7A', 'Уведомления',
          ...
          SettingsItem(Feather.getIconData("help-circle"), '#24ACE9', 'Помощь',
              'Заходи, если нужна помощь', () {
            Navigator.push(
              context,
              PageTransition(
                type: PageTransitionType.fade,
